...
''',
    ...
    if (
        ...
        return False
''',
    "role correction distance logic",
)
...
================ COVERAGE PLAN ================
''',
    "editorial enforcement conduit rule",
)
...
''',
    '''        deterministic_action_issues = (
        ...
        # SAVE
''',
    "formal action guard wiring",
)

pc_path.write_text(pc, encoding="utf-8")


tests = Path("tests/test_rsm_sept9_regressions.py")
tests.write_text(
...
print("RSM September 9 patch applied.")
